    ...
    <div class="dashboard-container">
        ...
        <form id="addMemberForm">
            ...
            <div class="form-row">
                ...
                <small style="color: #666;">Optional. Leave empty for family patriarchs/matriarchs.</small>
            </div>
    ...
    <script>
        jQuery(function ($) {
            ...
            $('#addMemberForm').on('submit', function (e) {
                ...
                btn.prop('disabled', true).html('Adding... <span class="loading-spinner"></span>');
