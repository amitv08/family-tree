        ...
        <div class="section">
            ...
            <div class="form-row form-row-2">
                ...
                <div class="form-group">
                    ...
                    <small class="form-help">Check if this member was adopted</small>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="form-row form-row-2">
                <div class="form-group">
                    ...
                    <input type="text" id="city" name="city" class="field-md" value="<?php echo esc_attr($member->city ?? ''); ?>" placeholder="e.g., London">
                </div>
                <div class="form-group">
                    <label class="form-label" for="state">🗺️ State/Province</label>
                    <input type="text" id="state" name="state" class="field-md" value="<?php echo esc_attr($member->state ?? ''); ?>" placeholder="e.g., England">
                </div>
            </div>
            ...
            <div class="form-row form-row-2">
                <div class="form-group">
                    ...
                    <input type="text" id="country" name="country" class="field-md" value="<?php echo esc_attr($member->country ?? ''); ?>" placeholder="e.g., United Kingdom">
                </div>
                <div class="form-group">
                    <label class="form-label" for="postal_code">📮 Postal Code</label>
                    <input type="text" id="postal_code" name="postal_code" class="field-sm" value="<?php echo esc_attr($member->postal_code ?? ''); ?>" placeholder="e.g., SW1A 1AA">
                </div>
            </div>
        </div>
